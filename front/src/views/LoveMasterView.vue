    ...
    <div class="chat-main">
      ...
      <div class="chat-container" ref="chatContainer">
        <div v-if="messages.length === 0" class="welcome-area">
          ...
          <h2 class="welcome-title">欢迎来到恋爱大师</h2>
          <p class="welcome-desc">我是你的专属 AI 情感顾问，可以帮你分析情感问题、提供约会建议、改善亲密关系</p>
...
import { chatWithLoveApp, apiListConversations, apiCreateConversation, apiGetConversationMessages, apiDeleteConversation } from '../api/index.js'
...
async function loadConversations() {
  try {
    const res = await apiListConversations('love_app')
...
async function newConversation(title = '新对话') {
  messages.value = []
  try {
    const res = await apiCreateConversation('love_app', title)
    if (res.code === 0) {
